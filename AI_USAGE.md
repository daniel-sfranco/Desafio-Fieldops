...
Modelos também foram gerados, no backend, sendo que estes foram criados no início do desenvolvimento da aplicação, e ao longo do desenvolvimento das rotas foram ajustados conforme necessidade.
