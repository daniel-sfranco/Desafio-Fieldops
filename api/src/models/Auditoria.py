...
class Auditoria(base):
    ...
    workOrder: Mapped["OS"] = relationship("OS", back_populates="auditList")# pyright: ignore[reportUndefinedVariable]
    actor: Mapped["Usuario"] = relationship("Usuario", back_populates="auditList")# pyright: ignore[reportUndefinedVariable]